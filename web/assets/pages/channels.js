...
(function () {
  ...
  async function load() {
    ...
    if (!proc.ok) {
      document.getElementById("proc-list").innerHTML = '<div class="empty">Controller unreachable</div>';
      return;
    }
    ...
    window.__procChannels = proc.data.channels || [];
  }
  ...
  document.getElementById("btn-save").addEventListener("click", async function () {
    ...
    api.toast("Channel saved", "success");
    editor.hidden = true;
    load();
  });
